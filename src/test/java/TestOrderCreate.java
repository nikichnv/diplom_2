...
public class TestOrderCreate {
    ...
    //Комметарий для ревьюера: Заказ не должен создаваться согласно требованиям:
    ...
    public void testOrderCreateWithoutToken() {
        List<String> ingredients = Arrays.asList("61c0c5a71d1f82001bdaaa6d", "61c0c5a71d1f82001bdaaa70");
